...
var mensaje_extra string
var mensaje_extra_bool bool = false
	...
	if m.Content == current_text && is_started {
		...
		if wpm > AAA {
			...
			if !(tops[random*5][5] == m.Author.ID) {
				...
				mensaje_extra = "¡Muy bien, " + m.Author.Username + ", has superado tu anterior marca de " + tops[random*5][2] + " WPM del " + tops[random*5][3]
				mensaje_extra_bool = true
			}
			...
			if wpm > AAA {
				...
				if (tops[random*5][5] == m.Author.ID) {
					s.ChannelMessageSend(m.ChannelID, m.Author.Username + ", no has logrado superar tu anterior marca de " + tops[random*5][2] + " WPM del " + tops[random*5][3])
				} else {
					...
					if !(tops[random*5+1][5] == m.Author.ID) {
						...
						mensaje_extra = "¡Muy bien, " + m.Author.Username + ", has superado tu anterior marca de " + tops[random*5+1][2] + " WPM del " + tops[random*5+1][3]
						mensaje_extra_bool = true
					}
				...
				if wpm > AAA {
					...
					if (tops[random*5+1][5] == m.Author.ID) {
					s.ChannelMessageSend(m.ChannelID, m.Author.Username + ", no has logrado superar tu anterior marca de " + tops[random*5+1][2] + " WPM del " + tops[random*5+1][3])
				} else {
					...
					if !(tops[random*5+2][5] == m.Author.ID) {
							...
							mensaje_extra = "¡Muy bien, " + m.Author.Username + ", has superado tu anterior marca de " + tops[random*5+2][2] + " WPM del " + tops[random*5+2][3]
							mensaje_extra_bool = true
						}
				...
				if (tops[random*5+2][5] == m.Author.ID) {
					s.ChannelMessageSend(m.ChannelID, m.Author.Username + ", no has logrado superar tu anterior marca de " + tops[random*5+2][2] + " WPM del " + tops[random*5+2][3])
				} else {
						if !(tops[random*5+3][5] == m.Author.ID) {
							...
							mensaje_extra = "¡Muy bien, " + m.Author.Username + ", has superado tu anterior marca de " + tops[random*5+3][2] + " WPM del " + tops[random*5+3][3]
							mensaje_extra_bool = true
						} 
				...
				/*Set to float*/ if AA, err := strconv.ParseFloat(tops[random*5+4][2], 64); err == nil {AAA = AA}
					if wpm > AAA {
						...
						if (tops[random*5+3][5] == m.Author.ID) {
							s.ChannelMessageSend(m.ChannelID, m.Author.Username + ", no has logrado superar tu anterior marca de " + tops[random*5+3][2] + " WPM del " + tops[random*5+3][3])
						} else {
							if (tops[random*5+4][5] == m.Author.ID) {
								mensaje_extra = "¡Muy bien, " + m.Author.Username + ", has superado tu anterior marca de " + tops[random*5+4][2] + " WPM del " + tops[random*5+4][3]
								mensaje_extra_bool = true
							}
							s := fmt.Sprintf("%f", wpm)  
							tops[random*5+4][2] = s
